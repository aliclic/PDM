                    ...
                    NavHost(navController = navController, startDestination = "login") {
                        ...
                        composable("cadastro") {
                            TelaCadastro(
                                modifier = Modifier.padding(innerPadding),
                                onSignupComplete = {
                                    navController.popBackStack("login", false) // Voltar para a tela de login
                                }
                            )
                        }
                            ...
                            TelaPrincipal(
                                ...
                                onLogoffClick = {
                                    navController.navigate("login") {
                                        popUpTo("principal") { inclusive = true } // Voltar para a tela de login e limpar a pilha de navegação
                                    }
                                }
                            )
                        }
